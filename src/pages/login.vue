...
.container{
    ...
    background-image: url("../images/weixin_tool_bc.jpg");
    .top_part{
        flex-grow: 1;
        display: flex;
        align-items: center;
...
<div class="container">
    <div class="top_part">
        <div id="login_box" :style="activeName=='sign_up' ? 'padding-top:40px;' : 'padding-top:37px;'">
            <img class="logo" src="../images/wx_gsy_login.png" alt="logo">
                    ...
                    <el-form :model="sign" :rules="rules" ref="sign">
                        <div v-if="activeName=='sign_up'">
                            <el-form-item prop="mobile">
                                <el-input class="mobile" placeholder="手机号码" v-model.trim="sign.mobile" @blur="checkSignUp"></el-input>
                            </el-form-item>
                            <el-form-item prop="message_code">
                                <el-input placeholder="短信验证码" v-model.trim="sign.message_code">
                            ...
                            <el-form-item prop="username">
                                <el-input placeholder="姓名" v-model.trim="sign.username"></el-input>
                            </el-form-item>
                            <el-form-item prop="password">
                                <el-input placeholder="设置密码" type="password" v-model.trim="sign.password" @keyup.enter.native="signUp('sign')"></el-input>
                            </el-form-item>
                            <el-form-item>
                        ...
                        <div v-if="activeName=='sign_in'">
                            ...
                            <el-form-item prop="password" v-show="!forgetPwd">
                                <el-input placeholder="登录密码" type="password" v-model.trim="sign.password" @keyup.enter.native="signIn('sign')"></el-input>
                            </el-form-item>
                            <el-form-item prop="message_code" v-if="forgetPwd">
                                <el-input placeholder="短信验证码" v-model="sign.message_code">
                                    <el-button slot="append" style="width:120px" @click="getMessageCode('update_pwd')" :disabled="update_pwd_timer_disabled">
