    ...
    data() {
        ...
        computed: {
            ...
            store_url() {
                ...
                return 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6d36779ce4dd3dfa&redirect_uri='+ conf.url_encode_domain +'%2fone%2ftwo%2findex.html%23%2findex%2fmain&response_type=code&scope=snsapi_base&state=' + this.office_account.store_id + '&component_appid=wx1c2695469ae47724#wechat_redirect'
            }
        },
        mounted(){
            // set up Clipboard
